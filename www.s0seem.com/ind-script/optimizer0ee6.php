jQuery(document).ready(function() {
	...
	jQuery(".xans-product-detail .swiper6 .swiper-wrapper").each(function(){
		...
		if ( swiperslidelength > 1 ) {
			/*  추가이미지 없을시 여백조정 */
			jQuery(".xans-product-detail .imgArea .keyImg").css('width','600px');
			jQuery(".xans-product-detail .infoArea").css('margin-left','30px');

			setTimeout(function(){			
				/*  상세썸네일 세로값 고정 */
				var paginationHeight = $(".xans-product-detail .imgArea .keyImg .thumbnail").height();
				jQuery(".xans-product-detail .imgArea .swiper6").show().css("height", paginationHeight);
